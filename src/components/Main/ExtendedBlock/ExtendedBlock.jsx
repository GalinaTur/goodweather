        ...
        <>
            ...
            <nav className={styles.navigation}>
                ...
                {dailyForecast && Object.values(dailyForecast).map((value, id) => {
                    ...
                    return <NavLink to={`/details/${value[0].dayOfWeek[0].toLowerCase()}/`} key={id} className={({ isActive }) => isActive ? styles.active : styles.navlink}>{value[0].date.slice(0, 3)}</NavLink>
                })}
            </nav>
            <Routes>
